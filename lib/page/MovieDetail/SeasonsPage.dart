  ...
  buildSeason(Season season){
    return Padding(
      ...
      child: GestureDetector(
        onTap: () async{
          await movieProvider.loadSeason(_scaffoldKey, season.seasonNumber, widget.movie!.id);
          if(movieProvider.season!=null){
            Navigator.of(context).push(
                MaterialPageRoute(builder: (_) => EpisodesPage(poster: widget.movie!.poster!)));
          }
        },
        child: Container(
